...
const content: Content = {
  ...
  sections: [
    ...
    { heading: "Privacy and data", body: "The [Privacy](/privacy) page lists what the site stores and why. It is short, because there are no accounts and no analytics. Anything it does not answer is welcome through the channels above." },
