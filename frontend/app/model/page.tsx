      ...
      <div className="page">
        ...
        <header className="wrap masthead" style={{ paddingTop: 0 }}>
          ...
          <p className="deck">
            ...
            a two-layer MLP, backprop over 1.6 million ranked matches. It is also small enough to print.
        ...
        <section id="mask" className="wrap">
          ...
          <div className="grid-2 mt">
            <div className="panel">
              ...
              <p className="dim">Fresh masks each epoch make this free augmentation: 1.6 million matches become a
              different 1.6 million every pass.</p>
            </div>
            <div className="stack">
              <Equation
        ...
        <section id="train" className="wrap">
          ...
          <div className="stack">
            ...
            <div className="grid-2">
              <div className="tablewrap">
                <table>
                  <caption className="tcap">Defaults — the unattended retrain overrides exactly two of them</caption>
                  ...
                  <tbody>
                    ...
                    <tr><td>--candidates</td><td>1 · auto&nbsp;3</td><td>Best-of-N seeds on one shared split; lowest full-comp val log-loss ships</td></tr>
                    <tr><td>--max-full-delta</td><td>0.002 · auto&nbsp;0.0035</td><td>Hard publish gate vs the previous checkpoint</td></tr>
              ...
              <div className="panel panel-2">
                ...
                three.</p>
                <p className="dim">A sweep over <code>--p-full</code> × seeds with the gate disabled settled it
                on 23 Aug: seed-to-seed spread alone spans ~0.0035, above the 0.002 threshold, so a single-seed
                retrain passed or failed by coin flip. Since 24 Aug the unattended retrain trains three seeds,
                keeps the best, and gates at that measured floor; manual runs keep the strict default.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="worth" className="wrap">
          ...
          <div className="stack">
            <div className="tablewrap">
              <table>
                ...
                <tbody>
                  ...
                  <tr><td>Previous checkpoint, same val rows</td><td>0.6622</td><td>0.595</td><td>0.636</td><td>0.011</td></tr>
                  <tr className="hi"><td>Shipped net (masked, best of 3 seeds)</td><td>0.6650</td><td>0.590</td><td>0.630</td><td>0.011</td></tr>
                </tbody>
              </table>
            </div>
            <p className="note-line">The previous checkpoint wins this table, by{" "}
              <span className="mono">+0.0028</span> log-loss — and ships anyway. Reruns of this architecture from
              different seeds swing about <span className="mono">0.0035</span> on the same split, so on these rows
              the two are within noise of each other, and only one of them was fit to the current meta. The shipped
              net is the best of three candidate seeds, and the publish gate refuses anything past that noise
              floor. Partial-draft support itself was priced once, at the switch:{" "}
              <span className="mono">+0.0003</span> log-loss against the last unmasked checkpoint, with a 50/50
              masked mixture costing three times as much and buying nothing extra.</p>
            ...
            >
              ...
              from what was promised — 0.011 means the promise is kept to about a percentage point.{" "}
            ...
            <Fig caption={<>
              ...
              board. The line is expected calibration error, which never strays past a point and a half at any
              state — 0.011 to 0.014, tightest exactly where the model claims the most. A model that got louder as
              it learned more without staying honest would climb with the bars.
            </>}><EdgeCalibration /></Fig>
